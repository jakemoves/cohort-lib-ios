...
@interface CHSoundSampleCueTest : XCTestCase

@end

@implementation CHSoundSampleCueTest
...
- (void)testThatItInitsWithAValidSoundAsset {
    ...
    CHSoundSampleCue *cue = [[CHSoundSampleCue alloc] initWithSession:session andAsset:asset withTriggers:nil withTags:nil error:&error withCompletionBlock:voidBlock];
...
- (void)testThatItFiresTheCompletionCallback {
    ...
    NSBundle *bundle = [NSBundle bundleForClass:[self class]];
    CHSoundAsset *asset = [[CHSoundAsset alloc] initWithAssetId:@"clicktrack" inBundle:bundle andFilename:@"clicktrack.m4a" error:&secondaryError];
    CHSoundSampleCue *cue = [[CHSoundSampleCue alloc] initWithSession:session andAsset:asset withTriggers:nil withTags:nil error:&error withCompletionBlock:^void(){
...
- (void)testThatItThrowsErrorWithNilSession {
    ...
    CHSoundAsset *asset = [[CHSoundAsset alloc] initWithAssetId:@"clicktrack" inBundle:bundle andFilename:@"clicktrack.m4a" error:&secondaryError];
    CHVoidBlock voidBlock;
    CHSoundSampleCue *cue = [[CHSoundSampleCue alloc] initWithSession:nil andAsset:asset withTriggers:nil withTags:nil error:&error withCompletionBlock:voidBlock];
    XCTAssertNil(cue);
...
- (void)testThatItThrowsErrorWithNilAsset {
    ...
    CHSession *session = [[CHSession alloc] init];
    CHVoidBlock voidBlock;
    CHSoundSampleCue *cue = [[CHSoundSampleCue alloc] initWithSession:session andAsset:nil withTriggers:nil withTags:nil error:&error withCompletionBlock:voidBlock];
    XCTAssertNil(cue);
    XCTAssertNotNil(error);
